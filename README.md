...
# Actcam Zeroshot Joint Camera And

[![Python 3.10+](https://img.shields.io/badge/python-3.10%2B-blue.svg)](https://www.python.org/downloads/)
[![License: MIT](https://img.shields.io/badge/License-MIT-green.svg)](LICENSE)
[![Code style: black](https://img.shields.io/badge/code%20style-black-000000.svg)](https://github.com/psf/black)
![CI](https://github.com/regerah/Actcam-Zeroshot-Joint-Camera-And/actions/workflows/ci.yml/badge.svg)
...
> Omar El Khalifi, Thomas Rossi, Oscar Fossey, Thibault Fouque, Ulysse Mizrahi et al.
> Published: 2026-05-07 | [Paper Link](http://arxiv.org/abs/2605.06667v1)
...
git clone https://github.com/regerah/Actcam-Zeroshot-Joint-Camera-And.git
cd Actcam-Zeroshot-Joint-Camera-And
...
```bibtex
@article{actcam_zeroshot_joint_camera_and_2026,
  title={ActCam: Zero-Shot Joint Camera and 3D Motion Control for Video Generation},
  author={Omar El Khalifi, Thomas Rossi, Oscar Fossey, Thibault Fouque, Ulysse Mizrahi et al.},
  year={2026},
